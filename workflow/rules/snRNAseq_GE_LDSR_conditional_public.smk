...
rule ldsr_make_annot_cond_public:
    ...
    output:  "../results/04LDSR/annotation_files/LDSR_cond_public/snRNAseq.{PUBLIC_CELL_TYPE}.100UP_100DOWN.{CHR}.annot.gz"
    conda:   "../envs/ldsr.yml"
    ...
    log:     "../results/00LOG/04LDSR/shi_bc/make_annot.snRNAseq.{PUBLIC_CELL_TYPE}.100UP_100DOWN.Chr{CHR}.log"
    shell:
             """
...
rule ldsr_ld_scores_cond_public:
    input:   annot = "../results/04LDSR/annotation_files/LDSR_cond_public/snRNAseq.{PUBLIC_CELL_TYPE}.100UP_100DOWN.{CHR}.annot.gz",
    ...
    output:  "../results/04LDSR/annotation_files/LDSR_cond_public/snRNAseq.{PUBLIC_CELL_TYPE}.100UP_100DOWN.{CHR}.l2.ldscore.gz"
    conda:   "../envs/ldsr.yml"
    params:  bfile = "../resources/ldsr/reference_files/1000G_EUR_Phase3_plink/1000G.EUR.QC.{CHR}",
             ldscores = "../results/04LDSR/annotation_files/LDSR_cond_public/snRNAseq.{PUBLIC_CELL_TYPE}.100UP_100DOWN.{CHR}",
    ...
    log:     "../results/00LOG/04LDSR/LDSR_cond_public/snRNAseq.{PUBLIC_CELL_TYPE}.100UP_100DOWN.Chr{CHR}_ldsc.log"
    shell:
...
rule ldsr_stratified_baseline_v12_cond_public:
    input:   GWAS = "../results/GWAS_for_LDSR/{GWAS}_hg19_ldsc_ready.sumstats.gz",
             ...
             COND = expand("../results/04LDSR/annotation_files/LDSR_cond_public/snRNAseq.{PUBLIC_CELL_TYPE}.100UP_100DOWN.{CHR}.l2.ldscore.gz", PUBLIC_CELL_TYPE = config["PUBLIC_CELL_TYPES"], CHR = range(1,23))
    output:  "../results/04LDSR/part_herit/baseline_v1.2/LDSR_cond_public/snRNAseq.{COND_CELL_A}_vs_{PUBLIC_CELL_TYPE}.100UP_100DOWN.{GWAS}_baseline.v1.2.results"
    conda:   "../envs/ldsr.yml"
    params:  weights = "../resources/ldsr/reference_files/weights_hm3_no_hla/weights.",
             ...
             cond_anns = "../results/04LDSR/annotation_files/LDSR_cond_public/snRNAseq.{PUBLIC_CELL_TYPE}.100UP_100DOWN.",
             out_file = "../results/04LDSR/part_herit/baseline_v1.2/LDSR_cond_public/snRNAseq.{COND_CELL_A}_vs_{PUBLIC_CELL_TYPE}.100UP_100DOWN.{GWAS}_baseline.v1.2"
    message: "Running Prt Hrt with {wildcards.COND_CELL_A} vs. {wildcards.PUBLIC_CELL_TYPE}, 100UP_100DOWN and {wildcards.GWAS} GWAS"
    log:     "../results/00LOG/04LDSR/LDSR_cond_public/snRNAseq.{COND_CELL_A}_vs_{PUBLIC_CELL_TYPE}.100UP_100DOWN.{GWAS}.baseline.v1.2_partHerit.log"
    shell:
...
rule ldsr_stratified_summary_cond_public:
    input:   expand("../results/04LDSR/part_herit/baseline_v1.2/LDSR_cond_public/snRNAseq.{COND_CELL_A}_vs_{PUBLIC_CELL_TYPE}.100UP_100DOWN.{GWAS}_baseline.v1.2.results", COND_CELL_A = config['COND_CELL_A'], PUBLIC_CELL_TYPE = config["PUBLIC_CELL_TYPES"], GWAS = config['GWAS'])
    output:  "../results/04LDSR/part_herit/baseline_v1.2/LDSR_cond_public/snRNAseq_LDSR_{GWAS}_baseline.v1.2_summary.tsv"
    message: "Creating adult conditional summary file for {wildcards.GWAS} GWAS"
    params:  dir = "../results/04LDSR/part_herit/baseline_v1.2/LDSR_cond_public/",
             cell_types = "../resources/sheets/GE_celltypes_conditional_public.tsv"
    log:     "../results/00LOG/04LDSR/LDSR_cond_public/snRNAseq.{GWAS}_baseline.v1.2_partHerit.summary.log"
    shell:
             """
             ...
             for Line in $Lines
             do
             grep L2_2 ../results/04LDSR/part_herit/baseline_v1.2/LDSR_cond_public/snRNAseq."$Line".{wildcards.GWAS}_baseline.v1.2.results | sed "s/L2_2/$Line/g" >> {output} 2> {log}
             done
